            ...
            (function (module, exports, __webpack_require__) {
                    ...
                    function () {
                        _createClass(TimelinePlugin, null, [{
                            ...
                            value: function create(params) {
                                return {
                                    name: 'timeline',
                                    deferInit: params && params.deferInit ? params.deferInit :
                                        false,
                                    params: params,
                        ...
                        function TimelinePlugin(params, ws) {
                            ...
                            /** @private */
                            this.container = 'string' == typeof params.container ? document.querySelector(
                            ...
                            this._onZoom = this.params.zoomDebounce ? this.wavesurfer.util.debounce(
                                function () {
                                    return _this.render();
                        ...
                        _createClass(TimelinePlugin, [{
                            ...
                            value: function destroy() {
                                ...
                                this.wavesurfer.drawer.wrapper.removeEventListener('scroll',
                                    this._onScroll);
                            ...
                            value: function createWrapper() {
                                ...
                                this.wrapper = this.container.appendChild(document.createElement(
                                    'timeline'));
                            ...
                            value: function updateCanvases() {
                                ...
                                var addCanvas = function addCanvas() {
                                    var canvas = _this2.wrapper.appendChild(document.createElement(
                                        'canvas'));
                            ...
                            value: function updateCanvasesPositioning() {
                                ...
                                this.canvases.forEach(function (canvas, i) {
                                    ...
                                    // required width
                                    var canvasWidth = i === canvasesLength - 1 ?
                                        _this3.drawer.wrapper.scrollWidth - _this3.maxCanvasElementWidth *
                                        (canvasesLength - 1) : _this3.maxCanvasElementWidth; // set dimensions and style

                                    canvas.width = canvasWidth * _this3.pixelRatio; // on certain pixel ratios the canvas appears cut off at the bottom,
                                    // therefore leave 1px extra

                                    canvas.height = (_this3.params.height + 1) *
                                        _this3.pixelRatio;

                                    _this3.util.style(canvas, {
                                        width: "".concat(canvasWidth, "px"),
                                        height: "".concat(_this3.params.height,
                                            "px"),
                                        left: "".concat(i * _this3.maxCanvasElementWidth,
                                            "px")
                                    });
                                });
                            }
                            ...
                            value: function renderCanvases() {
                                ...
                                var duration = this.wavesurfer.timeline.params.duration ||
                                ...
                                var width = wsParams.fillParent && !wsParams.scrollParent ?
                                    this.drawer.getWidth() : this.drawer.wrapper.scrollWidth *
                                    wsParams.pixelRatio;
                                var height1 = this.params.height * this.pixelRatio;
                                var height2 = this.params.height * (this.params.notchPercentHeight /
                                    100) * this.pixelRatio;
                                ...
                                this.setFonts("".concat(fontSize, "px ").concat(this.params
                                    .fontFamily));
                                ...
                                renderPositions(function (i, curSeconds, curPixel) {
                                    if (i % primaryLabelInterval === 0) {
                                        ...
                                        _this4.fillText(formatTime(curSeconds,
                                            pixelsPerSecond), curPixel +
                                            _this4.params.labelPadding * _this4
                                                .pixelRatio, height1);
                                    }
                                ...
                                renderPositions(function (i, curSeconds, curPixel) {
                                    if (i % secondaryLabelInterval !== 0 && i %
                            ...
                            value: function fillRect(x, y, width, height) {
                                ...
                                this.canvases.forEach(function (canvas, i) {
                                    ...
                                    var intersection = {
                                        ...
                                        y1: y,
                                        x2: Math.min(x + width, i * _this5.maxCanvasWidth +
                                            canvas.width),
                                        y2: y + height
                                    };
                                    ...
                                    if (intersection.x1 < intersection.x2) {
                                        canvas.getContext('2d').fillRect(
                                            ...
                                            intersection.y1, intersection.x2 -
                                            intersection.x1, intersection.y2 -
                                            intersection.y1);
                                    }
                                });
                            }
                ...
                var _initialiseProps = function _initialiseProps() {
                    ...
                    this._onReady = function () {
                        ...
                        _this6.maxCanvasElementWidth = ws.drawer.maxCanvasElementWidth || Math.round(
                            _this6.maxCanvasWidth / _this6.pixelRatio);
